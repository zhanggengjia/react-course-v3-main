...
const CartItem = ({ cartItem }) => {
  ...
  return (
    <article key={cartID} className='mb-12 flex flex-col gap-y-4 sm:flex-row flex-wrap border-b border-base-300 pb-6 last:border-b-0 sm:items-center'>
      {/* IMAGE */}
      ...
      <div className="sm:ml-12">
        ...
        {/* REMOVE */}
        <button className='mt-2 link link-primary linkhover text-sm' onClick={removeItemFromTheCart}>remove</button>
      </div>
      {/* PRICE */}
