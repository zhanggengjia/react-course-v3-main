  ...
  return (
    <div className='mt-12 grid gap-y-8'>
      {(Array.isArray(products) ? products : []).map((product) => {
        ...
        return (
          <Link key={product.id} to={`/products/${product.id}`} className='p-8 rounded-lg flex flex-col sm:flex-row gap-y-4 flex-wrap bg-base-100 shadow-xl hover:shadow-2xl duration-300 group sm:items-center'>
